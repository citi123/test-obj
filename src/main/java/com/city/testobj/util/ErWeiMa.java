...
/**
 * Created by City Mo on 2018/4/2.
 */
public class ErWeiMa {
    public static BufferedImage create(String content,String charset) throws Exception{
    ...
    public static void main(String[] args) throws WriterException {
        ...
        // File logoFile = new File("D://QrCode//alipay.jpg");
    ...
    public static void drawLogoQRCode(File logoFile, File codeFile, String qrUrl, String note) {
        try {
            ...
            if (Objects.nonNull(logoFile) && logoFile.exists()) {
                ...
                // 开始绘制logo图片
                g.drawImage(logo, width * 2 / 5, height * 2 / 5, width * 2 / 4, height * 2 / 4, null);
                g.dispose();
                logo.flush();
            }
